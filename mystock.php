...
<li><a href="empview.php">Employee</a></li>
  ...
  <h2><b><center> MY STOCK DETAILS</center></b></h2><br>
  <br>
...
$db=new DatabaseCon;
$val=$_SESSION['uid'];
$q="select * from  stockorder inner join rform on stockorder.vid=rform.vid inner join stock on stock.stoid=stockorder.stid where rform.vid='$val'";
$rs=$db->selectData($q);
while($row=mysql_fetch_array($rs))
{
    ...
    <td> &nbsp;&nbsp;&nbsp;<?php echo "<img src='uploads/".$row['img']."' width='150px' height='150px'";?>&nbsp;&nbsp;&nbsp;</td>
     <td>&nbsp;&nbsp;&nbsp;<?php echo $row['status'];?>&nbsp;&nbsp;&nbsp;</td>
     <?php
	 if($row['status']=="verified")
	 {
		 ?>
         <td><a href="buystock.php?id=<?php echo $row['stoid'];?>">&nbsp;&nbsp;&nbsp;<font color="#0033FF"><u>Order</u></font>&nbsp;&nbsp;&nbsp;</a></td>
    <?php
	 }
	 ?>
    </tr>
