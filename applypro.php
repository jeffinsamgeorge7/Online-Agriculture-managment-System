...
<li><a href="empview.php">Employee</a></li>
  ...
  <br>
  <form action="apaction.php"  onSubmit="return check();">
  <?php
include "DatabaseCon.php";
$db=new DatabaseCon;
$id=$_GET['id'];
$q="select * from product where proid='$id'";
$rs=$db->selectData($q);
$row=myqli=fetch_array($rs);
	?>
<table align="center">
<tr>
<td><input type="hidden" name="n" value="<?php echo $row['proid'];?>"></td>
</tr>
<tr>
