...
<head>
  ...
  ?>
 <style>
 body {background-image:url(img/bg-img/214.jpg);
 }
 </style>
</head>
...
while($row=mysql_fetch_array($rs))
{
	...
	{
		?>
    <td><a href="stapr.php?id=<?php echo $row['rfid'];?>">&nbsp;&nbsp;&nbsp;Approve&nbsp;&nbsp;&nbsp;</a></td>
     <td><a href="strjct.php?id=<?php echo $row['rfid'];?>">&nbsp;&nbsp;&nbsp;Reject&nbsp;&nbsp;&nbsp;</a></td>
    <?php
	}
	?>
    </tr>
