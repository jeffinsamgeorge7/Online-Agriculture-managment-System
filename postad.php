    ...
    <div class="container">
      ...
      <div class="row justify-content-center">
        ...
        <!-- Single Benefits Area -->
           ...
           <form action="adaction.php">
          
          <table>
          <tr><th><h1>Post your ad</h1></th></tr>
         
         <div><tr><td> Crop&nbsp;Name</td>
          <td><input type="text" name="c1" id="c1" required /></td></tr></div>
          <!--<div><tr><td>Crop&nbsp;Image</td>
          <td><input type="text" name="c2" id="c2" required /></td></tr></div>-->
          <div><tr><td>Reguired&nbsp;Quantity</td>
          <td><input type="number" name="c3" id="c3" required />kg</td></tr></div>
