      ...
      <div class="row justify-content-center">
        ...
        <div class="col-12 col-sm-4 col-lg" >
          <div class="single-benefits-area wow fadeInUp mb-50" data-wow-delay="500ms" >
            <form action="logaction.php" id="login()">
            <table align="center">
            <center><b><font color="#FF0099" size="+6">LOGIN</font></b></center>
            <TR><TD>&nbsp;</TD></TR>
<tr><td>Username</td><td>&nbsp;
</td>
<td ><input type="text" name="t1" required class="btn btn-success" /></td></tr>
<tr><td>&nbsp;</td></tr>
<br />
<tr><td>Password</td><td></td>
<td><input type="password" name="t2" required class="btn btn-success" /></td></tr>
<tr><td>&nbsp;</td></tr>
<tr><td><input type="submit" value="LOGIN" class="btn btn-success"/></td>&nbsp;
<td><a href="cp.php">Forgot Password?</a></td></tr></table></form>
