...
<body style="background-image:url(img/bg-img/214.jpg)">
  ...
  <form action="scomaction.php">
  <h2><b><center>Write your complaints here</center></b></h2><br>
  <br>
  <center>Complaints  &nbsp;<textarea rows="10" cols="30" name="c" id="c"></textarea></center><br>
...
$q1="select * from complaint where vid='$val'";
...
while($row=mysql_fetch_array($rst))
{
	?>
<tr>
<td height="36"><?php echo $row['date'];?></td>
