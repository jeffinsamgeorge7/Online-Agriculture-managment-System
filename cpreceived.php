                ...
                <ul>
                 ...
                 <!-- <li><a href="our-product.html">Our Product</a></li>
                  ...
                  <li><a href="adview.php">Ad</a></li>
                   <li><a href="profview2.php">Profile</a></li>
...
$q1="select * from sell inner join register on sell.fid=register.rid where spid='$val'";
...
<table border="1" align="center" bgcolor="#99FFFF" style="color:#000">
<tr>
<th>Crop Id</th>
<th>Crop Name</th>
<th>Quantity</th>
...
while($row=mysqli_fetch_array($rst))
{
	?>
<tr>
<td height="36"><?php echo $row['sid'];?></td>
<td><?php echo $row['crname'];?></td>

<td><?php echo $row['qty'];?></td>
<td>
					<!--<img src="<?php echo $row['pic'];?>">-->
                    <a href=""><img src="file_display.php?id=<?php echo $row['id']; ?>"  alt="" height="100" width="90"></a>
				</td>
...
<td><?php echo $row['status'];?></td>
  <?php
                ...
                ?>
                <td><a href="crpapr.php?id=<?php echo $row['sid']; ?>">Accept</a></td><br /> <td><a href="crpcom.php?id=<?php echo $row['sid']; ?>">Reject</a></td>
