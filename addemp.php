...
<li><a href="addemp.php">Employee</a></li>
  ...
  <br>
 <form action="employeeaction.php" onSubmit="return check();">
...
<td><input type="text" name="emp_id"required class="btn btn-success"  /></td></tr>
<tr><td>&nbsp;</td></tr>
...
<td><input type="text" name="name"id="name"required class="btn btn-success"  /></td>
</tr>
<tr><td>&nbsp;</td></tr>
...
<td><textarea cols="30" rows="10" name="address"required class="btn btn-success" ></textarea><br /></td>
</tr>
<tr><td>&nbsp;</td></tr>
...
<td>
<input type="email" name="email" required class="btn btn-success" /></td>
</tr>
<tr><td>&nbsp;</td></tr>
...
<td>
<input type="text" name="cntno" id="cntno" maxlength="12" minlength="10" required class="btn btn-success" /></td>
</tr>
<tr><td>&nbsp;</td></tr>
...
<td><input type="password" name="pass"required class="btn btn-success"  />
</td>
</tr>
<tr><td>&nbsp;</td></tr>
...
<td>
<input type="password" name="cpass"required class="btn btn-success"  />
</td>
</tr><tr><td>&nbsp;</td></tr>

<tr><td><input type="submit" name="submit" value="Add"  class="btn btn-success" /></td></tr>
</table>
</form>
<br><br>
<br>
...
while($row=mysqli_fetch_array($rs))
{
    ...
    <td>&nbsp;&nbsp;&nbsp;<?php echo $row['eaddr'];?>&nbsp;&nbsp;&nbsp;</td>
    <td>&nbsp;&nbsp;&nbsp;<?php echo $row['email'];?>&nbsp;&nbsp;&nbsp;</td>
    <td>&nbsp;&nbsp;&nbsp;<?php echo $row['phno'];?>&nbsp;&nbsp;&nbsp;</td>
    <td><a href="delemp.php?id=<?php echo $row['e_id'];?>">&nbsp;&nbsp;&nbsp;Delete&nbsp;&nbsp;&nbsp;</a>
    </td>
    <!--<td><a href="upemp.php?id=<?php echo $row['e_id'];?>">update</a></td>-->
    </tr>
    <?php } ?>
    </table>
</div>
...
function check()
{
	...
	else if(!document.getElementById("cntno").value.match(numbers))
	{
		alert("please input numbers only,enter Phone number");
		return false;
	}
	else if(document.getElementById("cntno").value.length<10)
	{
		alert("please input  digits only,enter Phonr number");
		return false;
	}
