...
<body style="background-image:url(img/bg-img/214.jpg)">
            ...
            <div class="classy-menu">
              ...
              <div class="classynav">
                <ul>
                 ...
                 <li><a href="addftips.php">Farming tips</a></li>
                  <li><a href="viewcom.php">View complaints</a></li>
  ...
  <form action="tipaction.php">
  <h2><b><center>Farming Tips</center></b></h2><br>
  <br>
  <center>Tip Hint&nbsp;<input type="text" name="tn" id="tn"></center>
  <br>
  <center>Tips &nbsp;<textarea rows="10" cols="30" name="c" id="c"></textarea></center><br>
...
<td><a href="del.php?id=<?php echo $row['tip'];?>">Delete</a></td></tr>
<?php }?>
</table></div>
