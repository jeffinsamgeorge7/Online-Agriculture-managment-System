...
<li><a href="empview.php">Employee</a></li>
  ...
  <h2><b><center>PROFILE DETAILS </center></b></h2><br>
...
//session_start();
$val=$_SESSION['uid'];
$q="select * from registration where regid='$val'";
$rs=$db->selectData($q);
while($row=mysql_fetch_array($rs))
{
	?>
    <tr> <td>&nbsp;&nbsp;&nbsp;<?php echo "<img src='uploads/".$row['image']."' width='150px' height='100px'";?>&nbsp;&nbsp;&nbsp;</td></tr>
    <tr><th>User Id</th>
    <td><input type="text" name="r1" value="<?php echo $row['regid'];?>"></td></tr>
    <tr><td>&nbsp;</td></tr>
   <tr><th>Name</th>
    <td><input type="text" name="r2" value="<?php echo $row['name'];?>"></td></tr>
    <tr><td>&nbsp;</td></tr>
    <tr><th>Aadhar No.</th>
    <td><input type="text" name="r3" value="<?php echo $row['adharno'];?>"></td></tr>
    <tr><td>&nbsp;</td></tr>
    <tr><th>Address</th>
    <td><input type="text" name="r4" value="<?php echo $row['address'];?>"></td></tr>
    <tr><td>&nbsp;</td></tr>
    <tr><th>Gender</th>
    <td><input type="text" name="r5" value="<?php echo $row['gender'];?>"></td></tr>
    <tr><td>&nbsp;</td></tr>
    <tr><th>Phone no.</th>
    <td><input type="text" name="r6" value="<?php echo $row['phoneno'];?>" maxlength="10" minlength="10"></td></tr>
    <tr><td>&nbsp;</td></tr>
    <tr><th>Email</th>
    <td><input type="text" name="r7" value="<?php echo $row['email'];?>"></td></tr>
    <tr><td>&nbsp;</td></tr>
