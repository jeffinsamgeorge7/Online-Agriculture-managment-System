...
$q1="select * from ad where vid='$val'";
...
while($row=mysqli_fetch_array($rst))
{
	?>
<tr>
<td height="36"><?php echo $row['id'];?></td>
...
<td>
				...
				</td><td><?php echo $row['qty'];?></td>
                <td><a href="delete.php?id=<?php echo $row['id'];?>">Delete</a></td>
<!--<td><?php echo $row['ph'];?></td>
<td><?php echo $row['website'];?></td>
<td><a href="delcoach.php?id=<?php echo $row['idc'];?>">Delete</a></td>
<td><a href="upcoach.php?id=<?php echo $row['idc'];?>">Edit</a></td>-->
