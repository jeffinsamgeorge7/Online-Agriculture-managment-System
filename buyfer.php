...
while($row=mysqli_fetch_array($rs))
{
	?>
        ...
        <!--<div class="col-12 col-sm-6 col-lg-3" align="center">
            ...
            <div class="ghj" align="center" style="background-color:#FCF">
            <form action="fero.php">
            <!-- Product Description -->
             <!--<?php echo "<img src='uploads/".$row['img']."' width='250px' height='250px'";?>--><br>
              <h6><b><a href="#" class="product-title"><?php echo $row['name'];?></a></b></h6>
               <h6><b><a href="#" class="product-title"><?php echo $row['category'];?></a></b></h6>
                 <h3><a href="#" class="product-title"><?php echo $row['type'];?></a></h3>
              <h6 class="price">Rs.&nbsp;<?php echo $row['amount'];?>/-</h6>
              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
              <?php 
			  if($row['quantity']==0)
			  {
              ...
              <?php echo $row['quantity'];?> &nbsp;&nbsp;&nbsp;Quantities are available.
             
              &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;
              <form action="fero.php">
              <input type="hidden" name="id" value="<?php echo $row['ferid'];?>">
