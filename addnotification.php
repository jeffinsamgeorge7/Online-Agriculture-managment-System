...
<li><a href="time_view.php">Timing</a></li>
  ...
  <br>
 <center><h1><b>ADD NOTIFICATION</b></h1></center>
...
<td>
<input type="text" name="date" value="<?php echo date('Y-m-d');?>" class="btn btn-success"/>
</td>
</tr><tr><td>&nbsp;</td></tr>
<tr>
<td>
...
<td>
<input type="text" name="topic"required class="btn btn-success" />
</td>
</tr><tr><td>&nbsp;</td></tr>
<tr>
<td>
...
<td>
<input type="text" name="noti"required class="btn btn-success" />
</td>
</tr><tr><td>&nbsp;</td></tr>
<tr>
<td><input type="submit" name="submit" value="add" class="btn btn-success" />
</td>
</tr>
</table>
</form>
...
while($row=mysqli_fetch_array($rs))
{
    ...
    <td><a href="delnotif.php?id=<?php echo $row['noid'];?>">&nbsp;&nbsp;&nbsp;Delete&nbsp;&nbsp;&nbsp;</a>
    </td>
    </tr>
    <?php } ?>
    </table>
