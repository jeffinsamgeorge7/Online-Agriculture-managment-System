...
<li><a href="addemp.php">Employee</a></li>
  ...
  <h2><b><center>Add Fertiliser</center></b></h2><br>
  <br>
  <form action="fertiliser.php" method="post" enctype="multipart/form-data" onSubmit="return check();">
<table align="center">
<tr>
<td>
Category:
</td>
<td><select name="t2"required class="btn btn-success" >
...
<td>
<input type="text" name="qual" id="qual" maxlength="5" minlength="1" required class="btn btn-success"  />
</td>
</tr><tr><td>&nbsp;</td></tr>
<tr>
<td>
...
<td>
<input type="text" name="price"required class="btn btn-success"  />
</td>
</tr><tr><td>&nbsp;</td></tr>
...
<td><select name="ty" class="btn btn-success"/>
<option>All</option>
...
while($row=mysqli_fetch_array($rs))
{
    ...
    <td>
      <td><a href="delfer.php?id=<?php echo $row['ferid'];?>">&nbsp;&nbsp;&nbsp;Delete&nbsp;&nbsp;&nbsp;</a></td>
    <td><a href="upfer.php?id=<?php echo $row['ferid'];?>">&nbsp;&nbsp;&nbsp;Update&nbsp;&nbsp;&nbsp;</a></td>
    </tr>
    <?php } ?>
    </table></div>
