...
<li><a href="empview.php">Employee</a></li>
  ...
  <h2><b><center>MY PRODUCTS DETAILS </center></b></h2><br>
  <br>
...
$db=new DatabaseCon;
$val=$_SESSION['uid'];
$q="select * from  product inner join rform on product.proid=rform.fid where vid='$val'";
$rs=$db->selectData($q);
while($row=mysql_fetch_array($rs))
{
    ...
    <td> &nbsp;&nbsp;&nbsp;<?php echo "<img src='uploads/".$row['img']."' width='150px' height='150px'";?>&nbsp;&nbsp;&nbsp;</td>
	 ...
	 {
		 ?>
         <td><a href="buypro.php?id=<?php echo $row['proid'];?>">&nbsp;&nbsp;&nbsp;<font color="#0033FF"><u>Order</u></font>&nbsp;&nbsp;&nbsp;</a></td>
    <?php
	 }
	 ?>
    </tr>
