...
//session_start();
$val=$_SESSION['uid'];
$q="select * from employee where e_id='$val'";
$rs=$db->selectData($q);
while($row=mysql_fetch_array($rs))
{
	?>
    <tr><th>User Id</th>
    <td><input type="text" name="r1" value="<?php echo $row['e_id'];?>" class="btn btn-success" ></td></tr>
    <tr><td>&nbsp;</td></tr>
   <tr><th>Name</th>
    <td><input type="text" name="r2" value="<?php echo $row['ename'];?>"class="btn btn-success" ></td></tr>
    <tr><td>&nbsp;</td></tr>
    <tr><th>Employee No.</th>
    <td><input type="text" name="r3" value="<?php echo $row['emp_id'];?>"class="btn btn-success" ></td></tr>
    <tr><td>&nbsp;</td></tr>
    <tr><th>Address</th>
    <td><input type="text" name="r4" value="<?php echo $row['eaddr'];?>"class="btn btn-success" ></td></tr>
    <tr><td>&nbsp;</td></tr>
    
    <tr><th>Phone no.</th>
    <td><input type="text" name="r6" value="<?php echo $row['phno'];?>"class="btn btn-success" maxlength="12"></td></tr>
    <tr><td>&nbsp;</td></tr>
    <tr><th>Email</th>
    <td><input type="text" name="r7" value="<?php echo $row['email'];?>"class="btn btn-success" ></td></tr>
    <tr><td>&nbsp;</td></tr>
