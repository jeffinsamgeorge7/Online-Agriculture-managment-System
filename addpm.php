...
<li><a href="time_view.php">Timing</a></li>
  ...
  <br>
 <center><h1><b>ADD Practising method</b></h1></center>
<form action="practaction.php" onSubmit="return check();">
...
<td><input type="text" name="n"required class="btn btn-success" />
</td>
</tr><tr><td>&nbsp;</td></tr>
<tr>
<td>
...
<td><input type="text" name="d" value="<?php echo date('Y-m-d');?>"  required class="btn btn-success"/>
</td>
</tr><tr><td>&nbsp;</td></tr>
<tr>
<td>
...
<td>
<input type="text" name="s"required class="btn btn-success" id="s" />
</td>
</tr><tr><td>&nbsp;</td></tr>
<tr>
<td>
...
<td>
<input type="text" name="f" required class="btn btn-success"/>
</td>
</tr><tr><td>&nbsp;</td></tr>
<tr>
<td>
...
<td>
<input type="text" name="m"required class="btn btn-success" />
</td>
</tr><tr><td>&nbsp;</td></tr>
<tr>
<td>
...
<td>
<input type="text" name="de" required class="btn btn-success"/>
</td>
</tr><tr><td>&nbsp;</td></tr>
...
while($row=mysqli_fetch_array($rs))
{
    ...
    <td><a href="delpract.php?id=<?php echo $row['pm_id'];?>">&nbsp;&nbsp;&nbsp;Delete&nbsp;&nbsp;&nbsp;</a>
    </td>
    <td><a href="uppract.php?id=<?php echo $row['pm_id'];?>">&nbsp;&nbsp;&nbsp;Update&nbsp;&nbsp;&nbsp;</a></td> 
    </tr>
    <?php } ?>
    </table>
...
function check()
{
	if(!document.getElementById("s").value.match(letters))
	{
		alert("please input alphabets only,enter Season");
		return false;
	}
